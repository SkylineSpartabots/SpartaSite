...
const NavbarTab = ({ path, text, onClick }) => {
  ...
  return (
    <Link
      to={path}
      className={` transition-all delay-150 bg-size-200 bg-pos-0 font-productsans font-bold text-sm px-5 mr-2 mb-2 flex-initial block text-center text-md rounded text-frcpink/75 w-[100px] py-4 
