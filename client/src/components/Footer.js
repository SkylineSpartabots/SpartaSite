        ...
        <div className="flex justify-center">
          ...
          >
            <svg
              ...
              data-prefix="fab"
              data-icon="twitter"
              className={`${themebool?"":"invert"} svg-inline--fa fa-twitter w-4`}
              role="img"
          ...
          >
            <svg
              ...
              data-prefix="fab"
              data-icon="google"
              className={`${themebool?"":"invert"} svg-inline--fa fa-google w-3.5`}
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 488 512"
            >
          ...
          >
            <svg
              ...
              data-prefix="fab"
              data-icon="instagram"
              className={`${themebool?"":"invert"} svg-inline--fa fa-instagram w-3.5`}
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
        ...
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          ...
          <div className="">
            ...
            <p className="flex items-center justify-center md:justify-start mb-4">
              ...
              <a href="mailto:skyline.spartabots@gmail.com">skyline.spartabots@gmail.com</a>
            </p>
            <p className="flex items-center justify-center md:justify-start mb-4">
              <svg
                aria-hidden="true"
