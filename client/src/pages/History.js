  ...
  return (
    <div>
      ...
      <div className="bg-slate-100 flex flex-col gap-8 items-center p-8">
        ...
        <Card
          title="2024 — Artemis"
          text="Artemis is the Spartabots' current robot for the FIRST Challenge CRESCENDO, this robot was an Event Finalist at Auburn and a Semi-Finalist at Sammamish!\nStatus: In Use"
