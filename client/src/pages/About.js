            ...
            <div className="bg-slate-100 flex flex-col gap-8 p-8 items-center ">
                <div className="box">
                    ...
                    <p className="font-productsans text-base text-justify">
                        ...
                        <br/>
                        In six weeks, our completely student run team, utilizes our problem solving, critical thinking,
                        as well analytical abilities to create a robot.
                        <br/>
                        ...
                        <br/>
                        <br/>
                        Since then, we've won the World Championship (2018) and qualified for World's 4 times, making us
                        one of the most successful teams in the Pacific Northwest.
                    </p>
                </div>
                <div className="box">
